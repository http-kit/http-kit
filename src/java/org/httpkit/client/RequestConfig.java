...
public class RequestConfig {
    ...
    public RequestConfig(HttpMethod method, Map<String, Object> headers, Object body,
        ...
        //defautCompression, enableCompression, askCompression, disableDefaultCompression, disableAwaysCompressing,
        //addAcceptEncodingIfNotPresent
        //dontAddAcceptEncodingIfNotPresent
